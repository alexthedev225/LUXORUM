  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-black relative overflow-hidden">
      <div className="relative w-full max-w-4xl xl:max-w-5xl">
        {/* Carte principale avec fond noir translucide, bordure et blur */}
        <div className="rounded-2xl p-8 backdrop-blur-sm shadow-2xl bg-black/60 ">
          {/* En-tête */}
          <div className="text-center space-y-4 mb-8">
            ...
            <div>
              <h2 className="cinzel-decorative-black text-3xl font-bold text-white mb-2">
                Se connecter
              </h2>
