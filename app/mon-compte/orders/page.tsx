...
export default async function OrdersPage() {
        ...
        <div className="container mx-auto px-8 py-12">
          ...
          <header className="mb-16">
            <div className="border-b border-zinc-800/60 pb-8">
              ...
              <p className="text-zinc-400 text-sm mt-2 tracking-wider">
  ...
  return (
    <div className="min-h-screen bg-black">
      <div className="container mx-auto md:px-8 py-12 max-w-6xl">
        {/* Header Section */}
        ...
        <footer className="mt-16 pt-8 border-t border-zinc-800/40">
          <div className="flex items-center justify-center space-x-8 text-xs text-zinc-500">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="tracking-wider">Mises à jour en temps réel</span>
            </div>
          </div>
        </footer>
      </div>
